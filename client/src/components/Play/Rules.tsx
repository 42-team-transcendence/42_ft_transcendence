		...
		<PageWrapper>
			<div className="rules">
				<h1>The Bouncing Beginnings</h1>
					...
					<p><span>#1: </span>Two paddles, one on each side, and a bouncing pixel ball. Keep that ball in play, or you'll be the Pong loser of the day!</p>

					<p><span>#2: </span>No power-ups or fancy moves here. Just slide your paddle up and down, left and right, and defend with all your might.
					Pong parties were all the rage, as friends gathered 'round the TV screen, hooting and hollering, like they'd never seen.
					Pong's legacy grew, inspiring the gaming revolution we know today, from pixel to VR, it's come a long way!</p>

					<p><span>#3: </span>Score a point when your opponent drops the ball, but don't get too cocky, 'cause Pong can make you fall!</p>
					...
					So, here's to Pong, the game that started it all. From 1972 to forevermore, it'll always be a ball!</p>
				</p>
			</div>
		</PageWrapper>
	)
