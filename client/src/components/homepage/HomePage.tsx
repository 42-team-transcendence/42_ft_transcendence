...
function Homepage(): JSX.Element{ // le composant renvoie un élément JSX
    const navigate: any = useNavigate();//sera preferable remplacer any par le type si il est connu
    const from_leaderboard: string = "/leaderboard";
        ...
        <>
            <div className="column">
                ...
                <div className="ButtonHomePage">
                    ...
                    <CustomButton onClick={() =>{}}> How to Play </CustomButton>
                    <CustomButton onClick={handleLeaderboard}> Leaderboard </CustomButton>
                </div>
            </div>
        </>
