...
export default function Register() {
    ...
    return (
        ...
        <section>
            ...
            <Username user={user} setUser={setUser} validName={validName} setValidName={setValidName} userFocus={userFocus} setUserFocus={setUserFocus} />
            <Email email={email} setEmail={setEmail} validEmail={validEmail} setValidEmail={setValidEmail} emailFocus={emailFocus} setEmailFocus={setEmailFocus} />
            <Password pwd={pwd} setPwd={setPwd} validPwd={validPwd} setValidPwd={setValidPwd} pwdFocus={pwdFocus} setPwdFocus={setPwdFocus} />
            <ConfirmPassword matchPwd={matchPwd} setMatchPwd={setMatchPwd} validMatch={validMatch} setValidMatch={setValidMatch} matchFocus={matchFocus} setMatchFocus={setMatchFocus} pwd={pwd} />
